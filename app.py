...
with tab1:
    ...
    st.markdown("""
    <div style="padding:14px 20px; border:1px solid var(--c-border); border-radius:16px; background-color:#FFFFFF; display:flex; align-items:center; margin-bottom:10px;">
